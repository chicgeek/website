...
export const data = [
  ...
  },
  {
    ...
    content: <Fragment>
      ...
      <p>I write accessible HTML styled with SCSS. My JavaScript experience includes React, Redux, and Styled Components. I work with my team to ensure quality code, modularity, and maintainability.</p>
   </Fragment>
  },
  {
    id: 'leadership',
    ...
    content: <Fragment>
      ...
      <p>I am a reliable and trusted member of any team. I earn the respect of my coworkers through leadership and enabling others to do their best. I am an empathetic and supportive manager and enjoy mentoring other developers.</p>
      <h3>Culture and community</h3>
      <p>I strive to create and encourage a safe and inclusive work environment for everyone. Outside of work, <a href="https://inviqa.com/blog/how-user-groups-enrich-our-tech-community">I am involved with user groups</a>. I organise <a href="https://twitter.com/frontendsheff">Front&nbsp;End Sheffield</a> and previously organised Sheffield&nbsp;JS.</p>
    </Fragment>
  },
  {
    id: 'jobs',
    ...
    content: <Fragment>
      <ul>
        ...
        <li>
          ...
          <a href="https://www.uwo.ca/">University&nbsp;of&nbsp;Western&nbsp;Ontario</a>
        </li>
      </ul>
    </Fragment>
  },
